    ...
    <div class="bg-white shadow-sm rounded-lg w-full max-w-md p-8">
        ...
        <form class="space-y-5 " id="formRecuperation">
            ...
            <div>
                ...
                <input id="pwd" type="password" placeholder="Entrez un nouveau mot de passe"
            ...
            <div>
                ...
                <input id="pwd_conf" type="password" placeholder="Confirmez le mot de passe"
                    class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-cyan-500 focus:outline-none paragraphe"
                    required />
            </div>

            <button data-token = "<?= htmlspecialchars($token)?>" type="submit" id="sendBtn"

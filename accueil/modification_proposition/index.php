...
<body class="w-full h-screen flex flex-col relative">
    <main id="sections" class="h-screen w-full flex flex-col justify-between bg-black/10">
        ...
        <section id="section2" class="section w-full h-[92vh] flex justify-between items-center p-4">
            ...
            <div class="w-full h-full overflow-y-auto flex justify-center items-center gap-6 ">

                <div class=" w-full max-w-2xl rounded-lg relative bg-white p-6">

                    <h1 class="text-2xl font-bold text-gray-800 text-center mb-2 titre mt-8 flex justify-center gap-2 items-center">Modifier la compétence proposée <svg xmlns="http://www.w3.org/2000/svg" width="1.2em" height="1.2em" viewBox="0 0 24 24"><path fill="#000" fill-rule="evenodd" d="M3.25 22a.75.75 0 0 1 .75-.75h16a.75.75 0 0 1 0 1.5H4a.75.75 0 0 1-.75-.75" clip-rule="evenodd"/><path fill="#000" d="m11.52 14.929l5.917-5.917a8.2 8.2 0 0 1-2.661-1.787a8.2 8.2 0 0 1-1.788-2.662L7.07 10.48c-.462.462-.693.692-.891.947a5.2 5.2 0 0 0-.599.969c-.139.291-.242.601-.449 1.22l-1.088 3.267a.848.848 0 0 0 1.073 1.073l3.266-1.088c.62-.207.93-.31 1.221-.45q.518-.246.969-.598c.255-.199.485-.43.947-.891m7.56-7.559a3.146 3.146 0 0 0-4.45-4.449l-.71.71l.031.09c.26.749.751 1.732 1.674 2.655A7 7 0 0 0 18.37 8.08z"/></svg></h1>
                    <p class="text-gray-500 text-center paragraphe">Partagez votre savoir et aidez la communauté à grandir.</p>

                    <form id="proposition_form" class="space-y-4">
                        ...
                        <div>
                            ...
                            <input id="Titre_de_la_competence" value="<?= htmlspecialchars(trim(($proposition['Titre_de_la_competence'] ?? ''))) ?>" type="text" placeholder="Ex : Initiation à Photoshop" class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-cyan-500 focus:outline-none paragraphe" required />
                        </div>
                        ...
                        <div>
                            ...
                            <input id="Lieu_proposition" value="<?= htmlspecialchars($proposition['Lieu_proposition'] ?? '') ?>" type="text" placeholder="Ex : Lomé, quartier Adidogomé" class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-cyan-500 focus:outline-none paragraphe" />
                        </div>

                        <!-- CTA -->
                        <button data-post_id = "<?= htmlspecialchars($offre_id) ?>" id="btn_proposition" type="submit" class="w-full cursor-pointer bg-black text-white py-2 rounded-lg font-medium hover:bg-[#3396D3] transition paragraphe">Publier ma compétence</button>
    ...
    <script src="../../js/modifier_post.js"></script>
</body>
</html>
